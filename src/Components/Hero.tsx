...
import { getOptimisedAppearId } from "motion";
...
const Hero: React.FC = () => {
    ...
    useGSAP(()=> {
        ...
        gsap.fromTo('#hero h3' ,{opacity:0 , xPercent:-40} ,{opacity:1 ,duration:1, ease:'power1.inOut' , xPercent:0} )
  ...
  return (
    ...
    >
      <section id="hero" className=" mx-14">
        ...
        <h1 className="center text-white mt-14 mb-28 text-gradient" id="title">
